...
\title{Certificado de Recebíveis Imobiliários}
...
\section*{Cédula de Produto Rural}

\section*{Formas de Liquidação}

\section*{Prazo}

\section*{Nota Comercial do Agronegócio}

\subsection*{Características}

\subsection*{Rentabilidade}

\subsection*{Informações Obrigatórias no Prospecto}
